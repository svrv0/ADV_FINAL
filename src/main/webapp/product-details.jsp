...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .detail-row { display: grid; gap: 6px; padding: 16px 18px; border-radius: 16px; background: rgba(255, 220, 230, 0.2); border: 1px solid rgba(225, 170, 185, 0.2); }
        .detail-label { color: #b88a97; font-size: 0.82rem; text-transform: uppercase; letter-spacing: 0.1em; font-weight: 500; }
        .form-label { display: block; color: #2e1a20; font-size: 0.95rem; font-weight: 600; margin-bottom: 8px; }
        .detail-value { color: #2e1a20; font-size: 1.05rem; font-weight: 700; }
